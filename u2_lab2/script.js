function Calculo_notas(){
    ...
    if(!/^[A-Za-zÁÉÍÓÚáéíóúÑñ]*$/.test(nombre) || nombre === "" || nombre.length < 3 || nombre.length > 20){
        ...
        "</head>"+
        "<div class='bg-info p-2' style='-bs-bg-opacity: .1;'>"+
        "<body>"+
            "<div class=tablon>"+
                "<table class='Inicio'>"+
                ...
                "</table>"+
                "</div><div class= 'contenido'><h1><b> Has reprobado la asignatura </h1><br> Tu asignatura es: "+seleccion+" <br> Tu promedio fue: </b>"+prom_final2+
        "<br> <b> Estudiante:"+nombre+"</b> <h2 class = 'titulito'>Tus notas son: </h2>"+
        "<div class='tablita'>"+
        "<table class='tabla'>"+
        "<tr>"+ 
        "<td class='unidad'><b>UNIDAD 1 (33%)</b></td>"+
        ...
        "<body>"+
            "<div class=tablon>"+
                ...
                "</table>"+
                "</div><div class= 'contenido'><h1><b> Has aprobado la asignatura </h1><br> Tu asignatura es: "+seleccion+" <br> Tu promedio fue: </b>"+prom_final2+
        "<br> <b> Estudiante:"+nombre+"</b> <h2 class = 'titulito'>Tus notas son: </h2>"+
        "</div>"+
        "<div class='tablita2'>"+
        "<table class='tabla'>"+
